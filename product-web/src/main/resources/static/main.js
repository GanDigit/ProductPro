...
/* harmony import */ var _product_product_add_product_add_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./product/product-add/product-add.component */ "./src/app/product/product-add/product-add.component.ts");
/* harmony import */ var _product_product_update_product_update_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./product/product-update/product-update.component */ "./src/app/product/product-update/product-update.component.ts");
...
var routes = [
    ...
    {
        path: 'product',
        component: _product_product_list_product_list_component__WEBPACK_IMPORTED_MODULE_3__["ProductListComponent"],
        data: { title: 'Product List' }
    },
    {
        path: 'product-details/:id',
        component: _product_product_detail_product_detail_component__WEBPACK_IMPORTED_MODULE_6__["ProductDetailComponent"],
        data: { title: 'Product Details' }
    },
    {
        path: 'product-add',
        component: _product_product_add_product_add_component__WEBPACK_IMPORTED_MODULE_4__["ProductAddComponent"],
        data: { title: 'Product Add' }
    },
    {
        path: 'product-update/:id',
        component: _product_product_update_product_update_component__WEBPACK_IMPORTED_MODULE_5__["ProductUpdateComponent"],
...
var ProductService = /** @class */ (function () {
    function ProductService(http) {
        this.http = http;
        this.apiServiceURL = "http://localhost:8051/";
    }
    ...
    ProductService.prototype.loadEndPointURL = function () {
        ...
        return this.getAPIServiceURL().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (apiResponse) {
            ...
            console.log("endpoint URL : " + _this.apiServiceURL);
        }));
    };
    ProductService.prototype.getAPIServiceURL = function () {
        console.log("server URL : " + _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].server_URL);
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].server_URL + '/apiServiceURL');
    };
    ...
    ProductService.prototype.getProducts = function () {
        ...
        return this.http.get(this.apiServiceURL + '/api/product', httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(this.extractData));
    };
...
var ProductListComponent = /** @class */ (function () {
    function ProductListComponent(priceService, productService, route, router) {
    ...
    ProductListComponent.prototype.getPrice = function () {
    ...
    ProductListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_price_service__WEBPACK_IMPORTED_MODULE_3__["PriceService"], _product_service__WEBPACK_IMPORTED_MODULE_2__["ProductService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
